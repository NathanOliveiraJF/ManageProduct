...
<amp-sidebar id="sidebar" class="sample-sidebar" layout="nodisplay" side="left">
    ...
    <a href="dashboard.blade.php"><img src="/resources/images/go-jumpers.png" alt="Welcome" width="200" height="43" /></a>
    <div>
        <ul>
            <li><a href="categories.html" class="link-menu">Categorias</a></li>
            <li><a href="index.blade.php" class="link-menu">Produtos</a></li>
        </ul>
    </div>
</amp-sidebar>
<header>
    <div class="go-menu">
        ...
        <a href="dashboard.blade.php" class="link-logo"><img src="/resources/images/go-logo.png" alt="Welcome" width="69" height="430" /></a>
    </div>
    <div class="right-box">
